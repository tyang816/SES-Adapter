...
from src.esm.layers.regression_head import RegressionHead
from src.esm.layers.transformer_stack import TransformerStack
from src.esm.models.function_decoder import FunctionTokenDecoder
from src.esm.models.vqvae import (
    StructureTokenDecoder,
    StructureTokenEncoder,
)
from src.esm.sdk.api import (
    ESM3InferenceClient,
    ESMProtein,
    ESMProteinTensor,
...
from src.esm.tokenization import get_model_tokenizers
from src.esm.utils import encoding
from src.esm.utils.constants import esm3 as C
from src.esm.utils.constants.models import ESM3_OPEN_SMALL
from src.esm.utils.decoding import decode_protein_tensor
from src.esm.utils.generation import (
    iterative_sampling_raw,
    iterative_sampling_tokens,
)
from src.esm.utils.misc import rbf
from src.esm.utils.sampling import (
    get_default_sampling_config,
    sample_function_logits,
    sample_logits,
    sample_residue_annotation_logits,
)
from src.esm.utils.structure.affine3d import (
...
class ESM3(nn.Module, ESM3InferenceClient):
    ...
    def from_pretrained(
        ...
        from src.esm.pretrained import load_local_model
